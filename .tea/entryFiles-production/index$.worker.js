...
require('../../pages/discountDetaLis/discountDetaLis');
require('../../pages/bindingPhone/bindingPhone');
...
require('../../pages/enBug/enBug');
require('../../pages/refundDeposit/refundDeposit');
}
